...
```{r}
select(gapminder, year, lifExp, country)
```
...
```{r}
# Automatically takes the first line and puts it as the first argument
# If we want to put it as a different argument, add a dot %.>%, where '.' can be used on the next line as an argument
gapminder %>%
