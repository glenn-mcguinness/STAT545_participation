...
# Three main types of colour schemes
# Categorical - Want very different colours, qualitative colour palette
# Sequential - A range of values, quantitiative colour palette
p_scales +
    scale_x_log10(labels=dollar_format()) +
...
p %>% 
    ggplotly() %>% 
    htmlwidgets::saveWidget("testPlot.html")
```
